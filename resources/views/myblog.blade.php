        ...
        <div class='blog_container'>
            ...
            @if($user)
                ...
                <div id="comment_body{{$article->id}}" class='comment_body'>
                    ...
                    <form id="comentform{{$article->id}}" action="{{ route('comment.store')}}" method="post"
                          class="comentform" style='display: none'>

                        <textarea id='comment{{$article->id}}' class="comment" name="body" cols='30'
                                  rows='10'></textarea>
