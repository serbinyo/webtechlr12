...
@section('content')
    <section>
        ...
        <a href="exam" class="exam" id="examid">Экзамен по ВЕБ-технологиям</a>
    ...
    <script>
        var link = document.getElementById("examid");
        link.addEventListener("mouseover", function () {
            link.firstChild.nodeValue = 'ТААА-ДААА-ДААА-ДАААММ...';
            link.style.color = 'red';
        }, true);
        link.addEventListener("mouseout", function () {
            link.style.color = '#2C8DB8';
            link.firstChild.nodeValue = 'Экзамен по ВЕБ-технологиям';
        }, true);
    </script>
@endsection